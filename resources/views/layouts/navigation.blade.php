<nav x-data="{ open: false }" class="bg-white bg-opacity-30 dark:bg-gray-800 dark:bg-opacity-50 border-b border-gray-100 dark:border-gray-700">    <!-- Primary Navigation Menu -->

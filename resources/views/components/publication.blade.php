                    ...
                    <div id="comments-popup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                        <div class="bg-gray-800 rounded-lg w-full max-w-md mx-4 overflow-hidden border border-gray-700">
                            ...
                            <div class="flex border-b border-gray-700">
                                <button id="comments-tab" class="flex items-center justify-center gap-2 py-3 px-4 flex-1 text-white border-b-2 border-yellow-400">
                                ...
                                <div id="comments-content" class="space-y-4">
                                    @if(!empty($publication->comments))
                                        @foreach($publication->comments as $comment)
                                            ...
                                            <form class="like-comment-form flex items-center w-8" data-comment-id="{{ $comment->id }}">
                                                @csrf
                                                <button type="submit" class="group flex items-center text-gray-500 transition-colors like-button">
                                                    @if($comment->is_liked)
                                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px"
                                                    ...
                                                    @endif
                                                    <span class="likes-count text-sm ml-1">{{ $comment->likes ?? 0 }}</span>
                                                </button>
                                            </form>

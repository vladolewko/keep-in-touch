                    ...
                    <div class="mx-auto mb-5">
                        <div class="bg-gray-800  bg-opacity-75  rounded-lg overflow-hidden border border-gray-700 p-6">
                            ...
                            <div class="flex items-center justify-between mb-6 border-b border-gray-700 pb-4">
                                <a class="flex items-center" href="{{ route('users.profile', ['id' => $user->id]) }}">
                                    <div
                                        class="w-16 h-16 rounded-full bg-gray-600 mr-4 flex items-center justify-center">
                                        @if($user->getMedia('profile_images')->isNotEmpty())

                                            <img class="w-16 h-16 rounded-full bg-cover"
                                                 src="{{ $user->getFirstMediaUrl('profile_images') }}"
                                                 alt="Publication Image">
                                        @else

                                            <span
                                                class="text-white font-semibold">{{ strtoupper(substr($user->nickname, 0, 1)) }}</span>
                                        @endif
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex">
                                    <div class="w-28 text-gray-400 font-semibold text-sm">{{ __('profile-info.name') }}
                                        :
                                    </div>
                                ...
                                <div class="flex">
                                    <div
                                        class="w-28 text-gray-400 font-semibold text-sm">{{ __('profile-info.surname') }}
                                        :
                                    </div>
                                ...
                                <div class="flex">
                                    <div
                                        class="w-28 text-gray-400 font-semibold text-sm">{{ __('profile-info.nickname') }}
                                        :
                                    </div>
                                ...
                                <div class="flex">
                                    <div class="w-28 text-gray-400 font-semibold text-sm">{{ __('profile-info.bio') }}
                                        :
                                    </div>

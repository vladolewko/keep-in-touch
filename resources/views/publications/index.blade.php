                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('publications.sort', ['parameter' => 'likes ASC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'likes ASC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'likes DESC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'likes DESC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'newest', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ !request()->get('parameter') || request()->get('parameter') == 'newest' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'oldest', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'oldest' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'reposts ASC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'reposts ASC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'reposts DESC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'reposts DESC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'comments ASC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'comments ASC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['parameter' => 'comments DESC', 'filter' => request()->get('filter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('parameter') === 'comments DESC' ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('publications.sort', ['filter' => 'subscriptions', 'parameter' => request()->get('parameter'), 'search' => request()->get('search')]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 {{ request()->get('filter') ? '' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400' }}"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
                        ...
                        <a href="{{ route('publications.sort', ['filter' => null, 'parameter' => null, 'search' => null]) }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-2 text-gray-400 dark:text-gray-500 group-hover:text-red-600 dark:group-hover:text-red-400"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round"
